...
class Op_Checkout_OnepageController extends Mage_Checkout_Controller_Action
{
    /**
    ...
    public function indexAction()
    {
        ...
        $merchantId = Mage::getStoreConfig('payment/opcheckout/merchant_id');
        $merchantSecret =  Mage::helper('core')->decrypt(Mage::getStoreConfig('payment/opcheckout/auth_code'));

        if (empty($merchantSecret) || empty($merchantId)){

            $this->_redirect('checkout/cart');
            Mage::getSingleton('core/session')->addError('Op Payment Service API credentials are missing. Please contact support');
            return;
        }
